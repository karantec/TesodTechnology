        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            <h1 className="text-6xl font-bold mb-6 leading-tight text-white tracking-tight">
              About Tesod <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-purple-200">Technology</span>
            </h1>
            <p className="text-2xl text-blue-100 font-light">Innovating for a better tomorrow since 2015</p>
          </div>
        </div>
      </header>
        ...
        <div className="mb-24">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-12 shadow-inner relative overflow-hidden">
            ...
            <p className="text-2xl text-gray-700 leading-relaxed max-w-4xl mx-auto text-center relative z-10 font-light">
              At Tesod Technology, we are committed to developing cutting-edge solutions that empower businesses to thrive in the digital age. We believe in technology that is <span className="text-blue-600 font-medium">accessible</span>, <span className="text-indigo-600 font-medium">sustainable</span>, and makes a <span className="text-purple-600 font-medium">positive impact</span> on society.
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="group">
              <div className="bg-white rounded-2xl shadow-lg transition-all duration-300 group-hover:shadow-2xl group-hover:-translate-y-2 overflow-hidden h-full flex flex-col">
                <div className="h-32 bg-gradient-to-r from-blue-600 to-blue-700 flex items-center justify-center relative overflow-hidden">
                  ...
                  <svg className="w-16 h-16 text-white relative z-10" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <div className="px-8 pb-8">
                  ...
                  <p className="text-blue-600 font-medium flex items-center">
                    Learn more
                    <svg className="w-4 h-4 ml-2 transition-transform duration-300 group-hover:translate-x-1" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="group">
              <div className="bg-white rounded-2xl shadow-lg transition-all duration-300 group-hover:shadow-2xl group-hover:-translate-y-2 overflow-hidden h-full flex flex-col">
                ...
                <div className="p-8 flex-grow">
                  <h3 className="text-2xl font-semibold mb-4 text-indigo-600">Android App Development</h3>
            ...
            <div className="group">
              <div className="bg-white rounded-2xl shadow-lg transition-all duration-300 group-hover:shadow-2xl group-hover:-translate-y-2 overflow-hidden h-full flex flex-col">
                ...
                <div className="p-8 flex-grow">
                  <h3 className="text-2xl font-semibold mb-4 text-purple-600">Digital Marketing</h3>
              ...
              <div className="p-10 border-r border-gray-100 group">
                <div className="flex flex-col items-center text-center">
                  <div className="w-20 h-20 bg-blue-100 rounded-full flex items-center justify-center mb-6 group-hover:bg-blue-600 transition-colors duration-300">
                    <svg className="w-10 h-10 text-blue-600 group-hover:text-white transition-colors duration-300" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              ...
              <div className="p-10 border-r border-gray-100 group">
                <div className="flex flex-col items-center text-center">
                  <div className="w-20 h-20 bg-indigo-100 rounded-full flex items-center justify-center mb-6 group-hover:bg-indigo-600 transition-colors duration-300">
                    <svg className="w-10 h-10 text-indigo-600 group-hover:text-white transition-colors duration-300" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                      <path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"></path>
                    </svg>
                  </div>
                  <h3 className="text-2xl font-semibold mb-4 text-indigo-600">Customer Success</h3>
              ...
              <div className="p-10 group">
                <div className="flex flex-col items-center text-center">
                  <div className="w-20 h-20 bg-purple-100 rounded-full flex items-center justify-center mb-6 group-hover:bg-purple-600 transition-colors duration-300">
                    <svg className="w-10 h-10 text-purple-600 group-hover:text-white transition-colors duration-300" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                      <path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z"></path>
                    </svg>
                  </div>
                  <h3 className="text-2xl font-semibold mb-4 text-purple-600">Integrity</h3>
        ...
        <div className="mb-24">
          ...
          <div className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-2xl p-12 shadow-inner">
            <div className="max-w-4xl mx-auto">
              <svg className="w-12 h-12 text-blue-300 mb-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              ...
              <p className="text-2xl font-light text-gray-700 leading-relaxed mb-6">
                Tesod Technology transformed our digital presence completely. Their team developed a cutting-edge web platform that increased our conversions by 40% and a mobile app that our customers love. Their attention to detail and customer-focused approach exceeded our expectations.
              </p>
        ...
        <div className="mb-24">
          <div className="bg-gradient-to-r from-blue-700 via-indigo-700 to-purple-800 rounded-2xl p-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready to Transform Your Digital Experience?</h2>
              <p className="text-blue-100 text-xl mb-8">Let's collaborate to create innovative solutions that drive your business forward.</p>
