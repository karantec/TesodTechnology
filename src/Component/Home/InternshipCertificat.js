...
//     try {
//       const response = await axios.post('https://backend.tesodtechnology.com/internship/create-internship', formData);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://backend.tesodtechnology.com/internship/create-internship",
        formData
      );
        ...
        <div className="bg-white rounded-xl shadow-xl overflow-hidden w-full">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-8 text-white">
            ...
            <p className="mt-2 opacity-90 text-center">
              Complete the form below to receive your internship completion
              certificate
            </p>
          </div>
          ...
          {isSubmitted ? (
            <div className="p-8 text-center">
              ...
              <p className="text-gray-600">
                You will receive your certificate via email within 3-5 business
                days.
              </p>
            </div>
          ) : (
