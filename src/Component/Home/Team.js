        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-blue-200 max-w-2xl mx-auto">
              Our diverse team of talented professionals combines deep technical expertise with 
              innovative thinking to deliver cutting-edge solutions for our clients worldwide.
            </p>
          </div>
        </div>
      </header>
        ...
        <section className="bg-white rounded-2xl shadow-xl p-10 mb-24 transform -mt-24 relative z-20 border border-gray-100">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center mb-8">
              ...
              <h2 className="text-4xl font-bold text-gray-800">Our Talented Professionals</h2>
            </div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Each member of our team brings unique skills, experience, and perspectives that contribute to our 
              collective success. Together, we're passionate about creating innovative solutions that make a difference.
            </p>
          </div>
