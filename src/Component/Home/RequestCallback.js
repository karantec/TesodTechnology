      ...
      <div className="w-full max-w-6xl relative overflow-hidden">
        ...
        <div className="relative bg-white p-6 sm:p-8 md:p-10 rounded-2xl shadow-2xl border border-gray-100">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-2">Request a Callback</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-indigo-600 to-blue-600 mx-auto mt-3 mb-4 rounded-full"></div>
            <p className="text-gray-600 max-w-lg mx-auto">Our team of experts will contact you within 24 hours to discuss your project needs and provide tailored solutions</p>
          </div>
          ...
          {isSubmitted ? (
            <div className="bg-green-50 border border-green-100 p-8 rounded-xl text-center mb-4 transform transition-all duration-500 shadow-md">
              ...
              <p className="text-green-700 text-lg mb-2">Your callback request has been submitted successfully.</p>
              <p className="text-green-600">Our team will contact you shortly at your preferred date and time.</p>
              <button 
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center text-sm text-gray-500 mt-4">
                <p>By submitting this form, you agree to Tesod Technology's <a href="#" className="text-indigo-600 hover:text-indigo-800 underline">privacy policy</a>.</p>
              </div>
            </form>
          )}
        </div>
...
const InputField = ({ icon, id, name, type, placeholder, label, value, onChange, required, error, min }) => (
  <div className="group">
    ...
    <div className="relative">
      ...
      <input
        ...
        required={required}
        min={min}
        className={`block w-full pl-10 pr-3 py-3 border-2 ${error ? 'border-red-300 bg-red-50' : 'border-gray-200 bg-white'} rounded-lg shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200`}
